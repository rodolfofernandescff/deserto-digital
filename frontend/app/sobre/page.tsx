  ...
  return (
    <div className="container-app py-12 space-y-16 animate-fade-in max-w-4xl mx-auto pb-24">
      ...
      <section className="space-y-6 card p-8 border-accent/20 bg-surface/30">
        <h2 className="text-2xl font-bold text-accent">Como um termômetro da exclusão</h2>
      ...
      <section className="space-y-8">
        <h2 className="text-2xl font-bold border-b border-border/50 pb-4">A Metodologia: 4 Componentes</h2>
        
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="card space-y-3">
            <div className="w-12 h-12 rounded-full bg-accent/10 flex items-center justify-center text-accent mb-2">📡</div>
            <h3 className="font-bold text-lg">Infraestrutura — Peso: 40%</h3>
          ...
          <div className="card space-y-3">
            <div className="w-12 h-12 rounded-full bg-critico/10 flex items-center justify-center text-critico mb-2">🚫</div>
            <h3 className="font-bold text-lg">Exclusão Pura — Peso: 30%</h3>
          ...
          <div className="card space-y-3">
            <div className="w-12 h-12 rounded-full bg-emergente/10 flex items-center justify-center text-emergente mb-2">💰</div>
            <h3 className="font-bold text-lg">Capacidade (Renda) — Peso: 20%</h3>
          ...
          <div className="card space-y-3">
            <div className="w-12 h-12 rounded-full bg-conectado/10 flex items-center justify-center text-conectado mb-2">⚡</div>
            <h3 className="font-bold text-lg">Backhaul de Fibra — Peso: 10%</h3>
      ...
      <section className="space-y-6">
        <h2 className="text-2xl font-bold border-b border-border/50 pb-4">Tabela de Níveis</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-8 border-t border-border/50">
        <section className="space-y-4">
          <h2 className="text-xl font-bold">As Fontes</h2>
